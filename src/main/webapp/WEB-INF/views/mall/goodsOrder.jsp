...
<body>
	<div class="order-title stretch">
		<div class="title-text col-xs-3 padding-collapse">
         <span name="goods_name" id="goods_name" ></span>
          订单列表</div>
...
<!-- ############################################################################################## -->
		...
		<table class="table table-hover table-striped table-align">	
			<caption class="title">						
				...
				<div class="input-group  pull-right" >
                   ...
                   <span name="order_count" id="order_count"  style='border-left:0px;border-top:0px;border-right:0px;border-bottom:1px;font-size:200%;font-family:黑体 ' ></span>
                   &nbsp; &nbsp; &nbsp;
                   <span style="font-family: 黑体">订单总额：</span>
                   <span name="sum_price" id="sum_price"  style='border-left:0px;border-top:0px;border-right:0px;border-bottom:1px;font-size:200%;font-family:黑体 ' ></span>元
				</div>
			</caption>
			<thead>	
				<tr>
	...
	cadleo_data('/mallOrder/list.htmls?goods_id='+sessionStorage.getItem('edit_id'));
	...
	//请求获取订单总额和订单总数
 	$.post(
		 "mallOrder/sumprice.htmls?goods_id="+sessionStorage.getItem('edit_id'),
		null,
		function(data){
			$("#order_count").html(data.data.order_count);
			$("#sum_price").html(data.data.sum_price);
