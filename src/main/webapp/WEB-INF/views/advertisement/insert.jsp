...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	...
	<div class="order-title stretch">
		<div class="title-text col-xs-3 padding-collapse">新增广告</div>
...
<!--                		<option value=""></option> -->
  ...
  <!-- ################################################################## -->
   ...
   cadleo_data('/ad/insertload.htmls');
    function showData(data){
    	$.when((function(){
    		...
    		load_page_data(data.data.adLocationList,'location_id','location_name','select[name="ad_location"]');
        	load_page_data(data.data.pixel_list,'pixel','pixel','select[name="ad_width_high"]');
