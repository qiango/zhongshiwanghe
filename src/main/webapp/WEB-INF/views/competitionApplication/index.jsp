...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <div class="panel panel-default col-xs-11 stretch panel-h-align">
        ...
        <table class="table table-hover table-striped table-align">
        	<caption class="title">
	            ...
	            <a href="#/competitionApplication/insert" 
	...
	function showData(data){
		...
		for(var i in data){
			...
			tds += "<td class='text-ellipsis'><a href='#/competitionApplication/modify' edit_id='"+data[i].competition_id+"' editable="+!data[i].numberOfSignUp +" class='fa fa-pencil-square-o v-align wj_edit_data' title='编辑'></a><a href='javascript:void(0);' editable='"+ !data[i].numberOfSignUp +"' delete_id='"+data[i].competition_id+"' delete_path='/competitionApplication/delete.htmls?competition_id="+ data[i].competition_id +"' back_path='/competitionApplication/index' class='fa fa-trash-o wj_delete_data' title='删除'></a><a href='#/competitionApplication/eye' edit_id='"+ data[i].competition_id +"' class='fa fa-eye wj_view_data' title='详情'></a></td>";
