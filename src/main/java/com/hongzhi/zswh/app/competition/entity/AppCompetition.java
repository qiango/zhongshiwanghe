...
public class AppCompetition {
	...
	private String competition_primary_id;
	...
	public String getCompertition_status_final() {
		return compertition_status_final;
	}

	public void setCompertition_status_final(String compertition_status_final) {
		this.compertition_status_final = compertition_status_final;
	}
	...
	public String getCompetition_primary_id() {
		return competition_primary_id;
	}

	public void setCompetition_primary_id(String competition_primary_id) {
