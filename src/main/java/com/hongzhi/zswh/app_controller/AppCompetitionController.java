...
import com.hongzhi.zswh.app_1_3.service.AppCompetitionService;
...
@RequestMapping("/{version}/app_competition")
   ...
   try {
       switch (version){
           case "v1.3":
               ...
               return ObjectUtil.jsonOut(appCompetitionService.getJoinCompetition(property,platform_id,competition_id));
           default:
               return null;
       }
