 ...
 * Creat time : May 31, 2016    2:00:55 PM
 */
public class NewsParam {
	...
	public String getNews_status_name() {
		return news_status_name;
	}
	public void setNews_status_name(String news_status_name) {
		this.news_status_name = news_status_name;
	}
	...
	public String getNews_range() {
		return news_range;
	}
	public void setNews_range(String news_range) {
		this.news_range = news_range;
	}
