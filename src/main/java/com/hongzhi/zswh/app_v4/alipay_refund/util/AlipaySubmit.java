...
import com.hongzhi.zswh.app_v4.alipay_refund.sign.MD5;
import com.hongzhi.zswh.app_v4.alipay_refund.util.httpClient.HttpProtocolHandler;
import com.hongzhi.zswh.app_v4.alipay_refund.util.httpClient.HttpRequest;
import com.hongzhi.zswh.app_v4.alipay_refund.util.httpClient.HttpResponse;
import com.hongzhi.zswh.app_v4.alipay_refund.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        String mysign = "";
        if(AlipayConfig.sign_type_refund.equals("MD5") ) {
    ...
    private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
        ...
        sPara.put("sign_type", AlipayConfig.sign_type_refund);
